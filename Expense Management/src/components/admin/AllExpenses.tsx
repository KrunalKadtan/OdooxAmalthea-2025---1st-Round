      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Complete oversight of all company expenses
          </p>
        </div>
          ...
          <Table>
            <TableHeader>
              <TableRow className="bg-gray-50 dark:bg-gray-800/50">
                <TableHead className="font-semibold text-gray-900 dark:text-gray-100">Employee</TableHead>
                ...
                <TableHead className="font-semibold text-gray-900 dark:text-gray-100">Workflow</TableHead>
                <TableHead className="font-semibold text-gray-900 dark:text-gray-100">Actions</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {filteredExpenses.map((expense) => (
                <TableRow key={expense.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/30">
                  ...
                  <TableCell className="text-gray-700 dark:text-gray-300">{expense.category}</TableCell>
                  <TableCell>
                    <div>
                  ...
                  <TableCell className="text-gray-700 dark:text-gray-300">{expense.date}</TableCell>
                  <TableCell>{getStatusBadge(expense.status)}</TableCell>
                  <TableCell>
                    {expense.workflowStep && (
                      <Badge variant="outline" className="font-medium">{expense.workflowStep}</Badge>
                    )}
                  </TableCell>
                  <TableCell>
